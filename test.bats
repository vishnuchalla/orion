...
@test "orion ols configuration test " {
  ...
  es_metadata_index="perf_scale_ci*" es_benchmark_index="ols-load-test-results*" run_cmd orion --config "examples/ols-load-generator.yaml" --hunter-analyze --es-server=${ES_SERVER}
  VERSION=$before_version
}
